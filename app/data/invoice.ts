...
interface FilteredResult
  extends Omit<Invoice, 'createdAt' | 'updatedAt' | 'customer_id'>,
    Pick<Customer, 'name' | 'email' | 'image_url'> {
  updatedAt: string;
  createdAt: string;
}

export const listFiltered = fetchHandler<
...
export const fetchPages = fetchHandler<[string], number>(
  async (query: string) => {
